...
#   tuesdays = 
		  ...
		  # :time 1-7pm
		  {:name => "City Farm Market Stand (Independently Run Farmers Market)", :address => "1204 N. Clybourn Ave., Chicago, IL", :zipcode => "60610", :linkcard => false, :open_monday => false, :open_tuesday => true, :open_wednesday => true, :open_thursday => true, :open_friday => true, :open_saturday => false, :open_sunday => false},
		  # :date => July 10-Sept. 28, 2012
		  # :time => 1-5:30

#   wednesdays = 
		  {:name => "Wood Street Farm Stand (Independently Run Farmers Market)", :address =>  "5814 S. Wood St., Chicago, IL", :zipcode => "60636", :linkcard => true, :open_monday => false, :open_tuesday => false, :open_wednesday => true, :open_thursday => false, :open_friday => false, :open_saturday => true, :open_sunday => false},
          # :date => April 18-Oct. 24, 2012
          # :time => 1-4pm
          {:name => "Green City Market (Independently Run Farmers Market)", :address => "2732 North Clark Street #302, Chicago, IL", :zipcode => "60614", :linkcard => true, :open_monday => false, :open_tuesday => true, :open_wednesday => false, :open_thursday => false, :open_friday => false, :open_saturday => false, :open_sunday => false},
#         # :date => May 5-Oct. 31, 2012
# 		  # :time => 7 am - 1 pm  
	      {:name => "The Wheeler Mansion Market (Independently Run Farmers Market)", :address => "2020 S. Calumet, Chicago, IL", :zipcode => "60616", :linkcard => true, :open_monday => false, :open_tuesday => false, :open_wednesday => true, :open_thursday => false, :open_friday => false, :open_saturday => false, :open_sunday => false},
# 		  # :time => 4-8pm
...
# 		  # :date => June 6-Oct. 31, 2012
# 		  # :time => 7am-1pm
		  {:name => "Andersonville (Independently Run Farmers Market)", :address => "Clark St and Berwyn Ave, Chicago, IL", :zipcode => "60640", :linkcard => true, :open_monday => false, :open_tuesday => false, :open_wednesday => true, :open_thursday => false, :open_friday => false, :open_saturday => false, :open_sunday => false},
# 		  # :date => June 13-Oct. 17, 2012
# 		  # :time => June 13-Sept. 5: 3 - 8 pm; Sept. 12-Oct. 17: 3 - 7 pm
		  {:name => "Covenant Bank - North Lawndale (Independently Run Farmers Market)", :address => "1111 S. Homan Ave., Chicago, IL", :zipcode => "60624", :linkcard => true, :open_monday => false, :open_tuesday => false, :open_wednesday => true, :open_thursday => false, :open_friday => false, :open_saturday => false, :open_sunday => false},
# 		  # :time => 8 am - 1 pm
...
# 		  # :date => July 11-Oct. 31, 2012
		  {:name => "Seaway Bank (Independently Run Farmers Market)", :address => "E 87th St & S Langley Ave, Chicago, IL", :zipcode => "60619", :linkcard => true, :open_monday => false, :open_tuesday => false, :open_wednesday => true, :open_thursday => false, :open_friday => false, :open_saturday => false, :open_sunday => false},
# 		  # :time => 9 am - 2 pm 
...
# 		  # :time => 7 am - 3 pm
		  {:name => "Uptown Farmers Market at Weiss (Independently Run Farmers Market)", :address => "4646 N. Marine Dr., Chicago, IL", :zipcode => "60640", :linkcard => false, :open_monday => false, :open_tuesday => false, :open_wednesday => false, :open_thursday => true, :open_friday => false, :open_saturday => false, :open_sunday => false}, 
...
#   fridays =
		  {:name => "The Rowan Tree Garden Society (Independently Run Farmers Market)", :address => "501 W. Englewood, Chicago, IL", :zipcode => "60621", :linkcard => false, :open_monday => false, :open_tuesday => false, :open_wednesday => false, :open_thursday => false, :open_friday => true, :open_saturday => false, :open_sunday => false},
# 		  # :date => May 18-Nov. 30, 2012
# 		  # :time => 8 am - 4 pm

#   saturdays =
  	     {:name => "61st Street (Independently Run Farmers Market)", :address => "6100 S. Blackstone Ave., Chicago, IL", :zipcode => "60637", :linkcard => true, :open_monday => false, :open_tuesday => false, :open_wednesday => false, :open_thursday => false, :open_friday => false, :open_saturday => true, :open_sunday => false},  
...
# 	     # :date => May 12-Oct. 27, 2012
#        # :time => 7 am - 1 pm
         {:name => "Eden Place (Independently Run Farmers Market)", :address => "4417 S. Stewart Ave., Chicago, IL", :zipcode => "60609", :linkcard => true, :open_monday => false, :open_tuesday => false, :open_wednesday => false, :open_thursday => false, :open_friday => false, :open_saturday => true, :open_sunday => false},
# 	     # :date => May 19-Oct. 20, 2012
# 	     # :time => 8 am - 3 pm 
	     {:name => "The West Humboldt Park Farmers Market and Bazaar (Independently Run Farmers Market)", :address => "3601 W. Chicago Ave., Chicago, IL", :zipcode => "60651", :linkcard => false, :open_monday => false, :open_tuesday => false, :open_wednesday => false, :open_thursday => false, :open_friday => false, :open_saturday => true, :open_sunday => false},
# 	     # :date => June 2, July 14, Aug. 11, Sept. 8 & Oct. 13, 2012
# 	     # :time => 10 am - 2 pm
	     {:name => "Edgewater (Independently Run Farmers Market)", :address => "N Broadway & W Norwood St, Chicago, IL", :zipcode => "60660", :linkcard => false, :open_monday => false, :open_tuesday => false, :open_wednesday => false, :open_thursday => false, :open_friday => false, :open_saturday => true, :open_sunday => false},
...
#        # :time => 7 am - 1 pm 
         {:name => "Bronzeville Community Market (Independently Run Farmers Market)", :address => "4400 S. Cottage Grove, Chicago, IL", :zipcode => "60653", :linkcard => true, :open_monday => false, :open_tuesday => false, :open_wednesday => false, :open_thursday => false, :open_friday => false, :open_saturday => true, :open_sunday => false},
...
#   	 # :time => 7 am - 1 pm
         {:name => "Glenwood Sunday Market (Independently Run Farmers Market)", :address => "6950 N. Glenwood, Chicago, IL", :zipcode => "60626", :linkcard => true, :open_monday => false, :open_tuesday => false, :open_wednesday => false, :open_thursday => false, :open_friday => false, :open_saturday => false, :open_sunday => true},
#        # :date => June 3-Oct. 28, 2012
#        # :time => 9 am- 3 pm
         {:name => "Logan Square (Independently Run Farmers Market)", :address => "N Milwaukee Ave & W Logan Blvd, Chicago, IL", :zipcode => "60647", :linkcard => true, :open_monday => false, :open_tuesday => false, :open_wednesday => false, :open_thursday => false, :open_friday => false, :open_saturday => false, :open_sunday => true},
#        # :date => June 3-Oct. 28, 2012
#        # :time => 10 am - 3 pm 
         {:name => "Pilsen Community Market(Independently Run Farmers Market)", :address => "1800 S. Halsted St., Chicago, IL", :zipcode => "60608", :linkcard => true, :open_monday => false, :open_tuesday => false, :open_wednesday => false, :open_thursday => false, :open_friday => false, :open_saturday => false, :open_sunday => true},
# 	     # :date => June 3-Oct. 28, 2012
#        # :time => 9 am - 3 pm 
         {:name => "Portage Park (Independently Run Farmers Market)", :address => "Central & Berteau, Chicago, IL", :zipcode => "60634", :linkcard => false, :open_monday => false, :open_tuesday => false, :open_wednesday => false, :open_thursday => false, :open_friday => false, :open_saturday => false, :open_sunday => true},
...
#        # :date => June 3-Oct. 28, 2012
#        # :time => 8 am - 2 pm 
         {:name => "Homegrown Bronzeville (Independently Run Farmers Market)", :address => "343-347 E. 51st Street, Chicago, IL", :zipcode => "60615", :linkcard => true, :open_monday => false, :open_tuesday => false, :open_wednesday => false, :open_thursday => false, :open_friday => false, :open_saturday => false, :open_sunday => true},
#        # :date => June 10-Oct. 28, 2012
#        # :time => 9am -1 pm
         {:name => "Independence Park (Independently Run Farmers Market)", :address => "3945 N. Springfield Ave., Chicago, IL", :zipcode => "60618", :linkcard => false, :open_monday => false, :open_tuesday => false, :open_wednesday => false, :open_thursday => false, :open_friday => false, :open_saturday => false, :open_sunday => true},
#        # :date => June 10-Oct. 28, 2012
#        # :time => 9am -1 pm
...
#        # :time => 2 - 6 pm
         {:name => "Jefferson Park Sunday Market (Independently Run Farmers Market)", :address => "5216 W. Lawrence Ave., Chicago, IL", :zipcode => "60630", :linkcard => false, :open_monday => false, :open_tuesday => false, :open_wednesday => false, :open_thursday => false, :open_friday => false, :open_saturday => false, :open_sunday => true}

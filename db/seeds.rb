...
#   wednesdays = 
          ...
          # :time => 1-4pm
      {:name => "Green City Market", :address => "2732 N. Clark Street #302, Chicago, IL", :zipcode => "60614", :linkcard => true, :open_monday => false, :open_tuesday => true, :open_wednesday => false, :open_thursday => false, :open_friday => false, :open_saturday => false, :open_sunday => false},
...
#         # :date => "June 6-Oct. 31, 2012"
      {:name => "South Shore", :address => "7054 S. Jeffery Blvd., Chicago, IL", :zipcode => "60649", :linkcard => true,:open_monday => false, :open_tuesday => false, :open_wednesday => true, :open_thursday => false, :open_friday => false, :open_saturday => false, :open_sunday => false},
# 		  # :date => June 6-Oct. 31, 2012
# 		  # :time => 7am-1pm
...
# 		  # :time => 7 am - 3 pm
		  {:name => "Hyde Park", :address => "53rd St. & Hyde Park Blvd., Chicago, IL", :zipcode => "60615", :linkcard => true, :open_monday => false, :open_tuesday => false, :open_wednesday => false, :open_thursday => true, :open_friday => false, :open_saturday => false, :open_sunday => false}, 
...
#        # :date => June 3-Oct. 28, 2012
#        # :time => 8 am - 2 pm 
         {:name => "Homegrown Bronzeville", :address => "343-347 E. 51st St., Chicago, IL", :zipcode => "60615", :linkcard => true, :open_monday => false, :open_tuesday => false, :open_wednesday => false, :open_thursday => false, :open_friday => false, :open_saturday => false, :open_sunday => true},
